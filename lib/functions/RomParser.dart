...
class RomParser {
  static final Map<String, String> _hepburnHR = __hepburn(true);
  static final Map<String, String> _hepburnRH = __hepburn(false);
  ...
  static Map<String, String> __hepburn(bool HR) {
